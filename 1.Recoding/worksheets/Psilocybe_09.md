...
## Coder A (Alessandra) — scene-level (13 distinct excerpts)

- **A01** @734 sc=100
  - items: Modal status of the hallucination | Impossible event; Type of visual alteration | Hallucination of a detached object
  - excerpt: 'The waves rose slowly and the rainbow pastel colors started to separate and replicate'
- **A02** @738 sc=100
  - items: Visual hallucination | Inorganic entity | Earth, river, sky, cloud
  - excerpt: 'waves'
- **A03** @764 sc=100
  - items: Visual hallucination | Inorganic entity | Other
  - excerpt: 'rainbow pastel color'
- **A04** @1612 sc=100
  - items: Nonsensory hallucination | Inorganic entity
  - excerpt: 'With the help of the music there was a rising and focusing of the intensity of the energy'
- **A05** @1703 sc=100
  - items: Modal status of the hallucination | Impossible event; Type of visual alteration | Hallucination of a detached object
  - excerpt: 'until there came a point where I gave birth to the universe, accompanied by ecstatic dancing.'
- **A06** @1754 sc=100
  - items: Visual hallucination | Inorganic entity | Earth, river, sky, cloud
  - excerpt: 'universe'
- **A07** @2247 sc=100
  - items: Type of visual alteration | Illusion
  - excerpt: 'The lights were dancing and Jimi Hendrix on the wall was a three dimensional mosaic doing his own undulating dance'
- **A08** @3694 sc=100
  - items: Type of visual alteration | Hallucination of a detached object
  - excerpt: 'Just this thinning and thinning as the cosmic winds blew through the center of where I had been until there was nothing.'
- **A09** @3726 sc=100
  - items: Modal status of the hallucination | Possible but improbable event
  - excerpt: 'as the cosmic winds blew through the center of where I had been until there was nothing.'
- **A10** @3733 sc=100
  - items: Visual hallucination | Inorganic entity | Other
  - excerpt: 'cosmic winds'
- **A11** @5697 sc=100
  - items: Type of visual alteration | Hallucination of a detached object
  - excerpt: 'when I turned my gaze, darkness followed behind, but what I looked at was illuminated.'
- **A12** @5697 sc=100
  - items: Modal status of the hallucination | Impossible event
  - excerpt: 'when I turned my gaze, darkness followed behind'
- **A13** @5720 sc=100
  - items: Visual hallucination | Extraordinary entity | Other
  - excerpt: 'darkness'

## Coder B (Brendan) — scene-level (1 distinct excerpts)

- **B01** @2247 sc=100
  - items: Type of visual alteration | Illusion
  - excerpt: 'The lights were dancing and Jimi Hendrix on the wall was a three dimensional mosaic doing his own undulating dance,'

## Coder A (Alessandra) — trip-level (20 distinct excerpts)

- **a01** @510 sc=100
  - items: Emotion | Negative emotion
  - excerpt: 'suddenly cold. My feet were cold, I was shivering, but I figured it was mostly pre-flight anxiety which is par for the course.'
- **a02** @653 sc=100
  - items: Arousal | Abnormally low
  - excerpt: 'Lying in bed quietly with eyes closed'
- **a03** @855 sc=77.21518987341773
  - items: Emotion | Negative emotion
  - excerpt: "The familiar disorientation and self-doubt rose up...'I'm not worthy' bullshit."
- **a04** @1124 sc=100
  - items: Ego dissolution | Bodily self
  - excerpt: "The center of 'me' became thinner and thinner until I was transparent."
- **a05** @1228 sc=100
  - items: Arousal | Abnormally low
  - excerpt: 'I got up and with difficulty'
- **a06** @1335 sc=100
  - items: Emotion | Positive emotion
  - excerpt: 'Of course the music meshed with and shaped reality, and helped a lot to quell the anxiety.'
- **a07** @1834 sc=100
  - items: Amnesia
  - excerpt: 'I remember this part as if it were a dream; by the time I could have described it with any clarity it was already swirling away. Really need to get a notebook or voice recorder set up next time.'
- **a08** @2482 sc=100
  - items: Sense of surprise and unexpectedness
  - excerpt: 'looking around at the room in wonder. The world was enchanted.'
- **a09** @3335 sc=100
  - items: Emotion | Positive emotion
  - excerpt: 'The open eyed visuals were so cool. Everything throbbed with significance'
- **a10** @3815 sc=100
  - items: Ego dissolution | Social self
  - excerpt: "I could see that I am nothing, not so much that I am everything though. I felt like I'd been spun so gently up through the clouds into the ether of nothingness that there wasn't a moment of change from something to nothing - there is definitely a farther frontier of nothingness to experience."
- **a11** @4109 sc=100
  - items: Emotion | Positive emotion
  - excerpt: 'But it was very nice. I liked the stillness.'
- **a12** @4909 sc=100
  - items: Sensory delight | Visual | Other
  - excerpt: 'just grooving on my own beauty in the mirror.'
- **a13** @5341 sc=100
  - items: Domain-specific violation | Psychological projection
  - excerpt: 'The trees welcomed me.'
- **a14** @5465 sc=100
  - items: Domain-specific violation | Psychological projection
  - excerpt: 'to where the full moon was rising between the trees - oh sister moon! We shined on each other for a while.'
- **a15** @5572 sc=100
  - items: Sensory delight | Haptic
  - excerpt: 'I could feel my hair on my shoulders and it felt so sensual.'
- **a16** @5784 sc=100
  - items: Emotion | Positive emotion
  - excerpt: 'It was so beautiful.'
- **a17** @5830 sc=100
  - items: Sensory delight | Auditory | Other
  - excerpt: 'and even the noises of cars in the distance were part of the symphony'
- **a18** @5856 sc=70.83333333333333
  - items: Sensory delight | Auditory | Nature
  - excerpt: 'The insects were humming...part of the symphony.'
- **a19** @5946 sc=100
  - items: Emotion | Positive emotion
  - excerpt: 'I noticed it was stuffy and too familiar, but cozy and wonderful as well. And the music was awesome.'
- **a20** @6020 sc=100
  - items: Sensory delight | Auditory | Music
  - excerpt: 'And the music was awesome.'

## Coder B (Brendan) — trip-level (1 distinct excerpts)

- **b01** @3592 sc=100
  - items: Ego dissolution | Core self
  - excerpt: "I was sort of hoping, waiting for a dramatic moment of ego-death, and there was nothing so clear cut. Just this thinning and thinning as the cosmic winds blew through the center of where I had been until there was nothing. I could see that I am nothing, not so much that I am everything though. I felt like I'd been spun so gently up through the clouds into the ether of nothingness that there wasn't…"
