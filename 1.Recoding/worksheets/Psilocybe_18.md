# Adjudication worksheet — Psilocybe_18

- substance: **psilocybin**  block: **11-20**
- coder_A: **Francesco**  coder_B: **Susana**
- dose_raw: `2 g`   word_count: **5531**
...
## Coder A (Francesco) — scene-level (9 distinct excerpts)

- **A01** @1780 sc=100
  - items: Type of visual alteration | Illusion
  - excerpt: 'Every breath I was taking, the starry night sky above me was repeating. It would expand and contract in rhythm with my diaphragm.'
- **A02** @2119 sc=100
  - items: Type of visual alteration | Illusion
  - excerpt: 'While walking I was staring down at the grass because it seemed to me to be arranging itself in geometric patterns'
- **A03** @2709 sc=100
  - items: Type of visual alteration | Illusion
  - excerpt: 'The patterns in the grass were also becoming more organized and more permanent.'
- **A04** @2896 sc=100
  - items: Dynamics of the hallucination | Object constancy; Modal status of the hallucination | Possible but improbable event; Type of visual alteration | Hallucination of a detached object; Visual hallucination | Animal | Insect
  - excerpt: 'it seemed to me to be a large white spider ambling along just to my left.'
- **A05** @5351 sc=100
  - items: Dynamics of the hallucination | Object constancy; Modal status of the hallucination | Impossible event; Type of visual alteration | Hallucination of an incrusted object; Visual hallucination | Inorganic entity | Other
  - excerpt: 'And then I looked up and saw a bright blue galaxy with yellow Mario stars transposed over the night sky in between two palm trees.'
- **A06** @9144 sc=100
  - items: Dynamics of the hallucination | Object constancy; Modal status of the hallucination | Impossible event; Type of visual alteration | Hallucination of a detached object; Visual hallucination | Animal | Mammal
  - excerpt: "At one point I looked at the city skyline and saw a Jaguar's eyes staring back at me from the horizon."
- **A07** @10193 sc=100
  - items: Dynamics of the hallucination | Object constancy; Modal status of the hallucination | Impossible event; Type of visual alteration | Hallucination of an incrusted object; Visual hallucination | Animal | Insect
  - excerpt: 'staring at Squaw Peak and seeing the outlines of spiders on both peaks.'
- **A08** @26770 sc=100
  - items: Dynamics of the hallucination | Object constancy; Modal status of the hallucination | Impossible event; Type of visual alteration | Hallucination of a detached object; Visual hallucination | Geometrical pattern
  - excerpt: 'I saw the green light of the smoke detector making a peace sign.'
- **A09** @28692 sc=100
  - items: Type of visual alteration | Illusion
  - excerpt: 'the words were moving across the screen'

## Coder B (Susana) — scene-level (14 distinct excerpts)
...
- **B03** @2119 sc=100
  - items: Type of visual alteration | Illusion
  - excerpt: 'While walking I was staring down at the grass because it seemed to me to be arranging itself in geometric patterns as I moved'
- **B04** @2133 sc=100
  - items: Modal status of the hallucination | Impossible event; Visual hallucination | Geometrical pattern
  - excerpt: 'I was staring down at the grass because it seemed to me to be arranging itself in geometric patterns as I moved'
- **B05** @2789 sc=100
  - items: Type of visual alteration | Illusion
  - excerpt: 'Additionally, the fuzzy edge of my scarf was visible at the periphery of my vision and while I was walking it seemed to me to be a large white spider ambling along just to my left'
- **B06** @2803 sc=100
  - items: Modal status of the hallucination | Possible and probable event
  - excerpt: 'the fuzzy edge of my scarf was visible at the periphery of my vision and while I was walking it seemed to me to be a large white spider ambling along just to my left'
- **B07** @2896 sc=100
  - items: Visual hallucination | Animal | Insect
  - excerpt: 'it seemed to me to be a large white spider'
- **B08** @5351 sc=100
  - items: Type of visual alteration | Hallucination of an incrusted object
  - excerpt: 'And then I looked up and saw a bright blue galaxy with yellow Mario stars transposed over the night sky in between two palm trees.'
- **B09** @5360 sc=100
  - items: Modal status of the hallucination | Impossible event
  - excerpt: 'I looked up and saw a bright blue galaxy with yellow Mario stars'
- **B10** @5376 sc=100
  - items: Visual hallucination | Inorganic entity | Other
  - excerpt: 'saw a bright blue galaxy with yellow Mario stars'
- **B11** @9157 sc=100
  - items: Modal status of the hallucination | Impossible event; Type of visual alteration | Hallucination of an incrusted object
  - excerpt: "I looked at the city skyline and saw a Jaguar's eyes staring back at me from the horizon"
- **B12** @9194 sc=100
  - items: Visual hallucination | Animal | Mammal
  - excerpt: "a Jaguar's eyes staring back at me from the horizon"
- **B13** @26752 sc=100
  - items: Type of visual alteration | Illusion
  - excerpt: 'when I looked up, I saw the green light of the smoke detector making a peace sign'
- **B14** @26770 sc=100
  - items: Domain-specific violation | Psychological projection; Modal status of the hallucination | Possible but improbable event; Visual hallucination | Human | Other(s)
  - excerpt: 'I saw the green light of the smoke detector making a peace sign'

## Coder A (Francesco) — trip-level (41 distinct excerpts)

- **a01** @1180 sc=100
  - items: Sense of strangeness and enigma
  - excerpt: 'everything took on an otherworldly glow'
- **a02** @1912 sc=100
  - items: Emotion | Negative emotion
  - excerpt: 'The nausea was reaching a point where it was becoming physically painful'
- **a03** @2534 sc=100
  - items: Sensory delight | Auditory | Music
  - excerpt: 'The music was starting to become fascinatingly enjoyable'
- **a04** @2970 sc=100
  - items: Emotion | Negative emotion
  - excerpt: 'Although this scared me at first,'
- **a05** @3004 sc=100
  - items: Sense of reality | Lucid
  - excerpt: 'I reminded myself that it was a hallucination and told myself to welcome any and all figments of imagination that my brain would throw at me'
- **a06** @4137 sc=100
  - items: Sense of surprise and unexpectedness
  - excerpt: 'The familiar landmarks I was used to, such as the lake and the playground, were still there, but they were in the wrong places.'
- **a07** @4610 sc=100
  - items: Emotion | Positive emotion
  - excerpt: "I'd been having fun moving my legs in rhythmic patterns."
- **a08** @5640 sc=100
  - items: Emotion | Positive emotion
  - excerpt: 'This gave me a huge surge of confidence and put in a good mood to start off my trip.'
- **a09** @6514 sc=100
  - items: Insight | Existential
  - excerpt: 'The spectre of being lost simply could not compete with the potential I held inside me.'
- **a10** @6849 sc=100
  - items: Emotion | Negative emotion
  - excerpt: 'It was painful, especially since my senses were heightened.'
- **a11** @8256 sc=100
  - items: Insight | Existential
  - excerpt: 'Pain is my validation.'
- **a12** @8567 sc=100
  - items: Emotion | Positive emotion
  - excerpt: 'But since my mood was still forceful and confrontational'
- **a13** @9077 sc=100
  - items: Sensory delight | Erotic
  - excerpt: 'I was aggressive, sexual and caught up in the nature of my desire.'
- **a14** @9647 sc=100
  - items: Emotion | Positive emotion
  - excerpt: "I'd reassured myself that I could feel the playfulness and aggression that are so integral to sexuality"
- **a15** @9952 sc=100
  - items: Amnesia
  - excerpt: "I don't remember much of the next song. I'm not sure if this is possible with psylocibin but I felt like I was so high that I was blacking out of consciousness every few minutes."
- **a16** @10320 sc=100
  - items: Sensory delight | Haptic
  - excerpt: 'I felt a strange sort of vibration rumbling all throughout my body to culminate at my hands. I would have stopped to enjoy the feeling,'
- **a17** @10460 sc=100
  - items: Emotion | Negative emotion
  - excerpt: "I was afraid that I'd freeze if I stayed still too long."
- **a18** @11004 sc=100
  - items: Insight | Existential
  - excerpt: 'experiencing so many spider motifs during my trip changed my opinion. They are beautiful because they produce such a strong response in us.'
- **a19** @12177 sc=100
  - items: Emotion | Negative emotion
  - excerpt: 'So I headed to warmth and felt a twinging regret'
- **a20** @12684 sc=100
  - items: Insight | Existential
  - excerpt: "I'm living my life seeking warmth and pretending I enjoy the cold."
- **a21** @13465 sc=100
  - items: Insight | Existential
  - excerpt: "I'd get to picture myself in my mind as I wanted to be and not who I needed to be to get others to like me."
- **a22** @14005 sc=100
  - items: Amnesia
  - excerpt: "That's means there are at least 11 minutes that I just don't remember."
- **a23** @14138 sc=100
  - items: Sense of reality | Delusional
  - excerpt: 'and thinking that I am Michael Jackson'
- **a24** @14964 sc=100
  - items: Emotion | Negative emotion
  - excerpt: "I almost stopped the song because I was frustrated that it wasn't addressing my scenario specifically"
- **a25** @16717 sc=100
  - items: Emotion | Negative emotion
  - excerpt: 'even though I was feeling pain, there were no tears in my eyes'
- **a26** @18806 sc=100
  - items: Emotion | Negative emotion
  - excerpt: "I felt ashamed and belittled that I didn't even have a place I could call my own"
- **a27** @20929 sc=100
  - items: Emotion | Negative emotion
  - excerpt: 'So I went inside very nervously'
- **a28** @21867 sc=100
  - items: Emotion | Negative emotion
  - excerpt: 'Now I was disgusted by myself and wondered how other people could stand to be around me without recoiling.'
- **a29** @22425 sc=100
  - items: Insight | Practical
  - excerpt: "The main idea that I'm going to take from this trip is that I need to leave my parents."
- **a30** @22932 sc=100
  - items: Emotion | Negative emotion
  - excerpt: "asked myself if I was happy with it. I wasn't."
- **a31** @23502 sc=100
  - items: Insight | Existential
  - excerpt: 'I am so much more than my body. There are ideas, actions, and ways of being that all belong to me and combine to create Zubair.'
- **a32** @23882 sc=100
  - items: Insight | Existential
  - excerpt: 'I am nebulously defined'
- **a33** @25079 sc=100
  - items: Emotion | Negative emotion
  - excerpt: 'I was afraid that I was going to fall unconscious into sleep in an effort to escape from the pain.'
- **a34** @26055 sc=100
  - items: Sense of reality | Lucid
  - excerpt: 'Even if the mental acuity to work through my problems was there, the drive was not.'
- **a35** @26285 sc=100
  - items: Emotion | Positive emotion
  - excerpt: 'what followed was a very relaxing and rewarding experience'
- **a36** @26835 sc=100
  - items: Emotion | Positive emotion
  - excerpt: 'It brought a smile to my face.'
- **a37** @26866 sc=100
  - items: Insight | Existential
  - excerpt: "I wish this moment had lasted longer because it brought out a side of me I didn't know existed"
- **a38** @27141 sc=100
  - items: Insight | Existential
  - excerpt: 'shitting your bowels out is just as much a part of life as dancing in ecstasy.'
- **a39** @27978 sc=100
  - items: Emotion | Positive emotion
  - excerpt: 'It was uplifting'
- **a40** @28536 sc=100
  - items: Emotion | Negative emotion
  - excerpt: 'worried that my parents would see my leaning against the hallway wall to keep my balance'
- **a41** @29187 sc=100
  - items: Insight | Existential
  - excerpt: "I'm going to change it all to suit my liking for the brief time I spend here."

## Coder B (Susana) — trip-level (32 distinct excerpts)

- **b01** @1133 sc=100
  - items: Sense of surprise and unexpectedness
  - excerpt: 'In the wan light provided by the streetlights, everything took on an otherworldly glow'
- **b02** @2246 sc=100
  - items: Dynamics of the hallucination | No object constancy
  - excerpt: 'When I stopped to examine the patterns more closely though, they would disappear'
- **b03** @2534 sc=100
  - items: Sensory delight | Auditory | Music
  - excerpt: 'The music was starting to become fascinatingly enjoyable'
- **b04** @2970 sc=100
  - items: Sense of reality | Lucid
  - excerpt: 'Although this scared me at first, I reminded myself that it was a hallucination'
- **b05** @8043 sc=100
  - items: Insight | Existential
  - excerpt: "Even though it hurts, I feel so strong when I force myself to bear the agony of physicality. Perhaps this also ties in to why I constantly cause myself emotional pain by interpreting other's actions as rejection. Pain is my validation."
- **b06** @9016 sc=100
  - items: Sensory delight | Erotic
  - excerpt: 'I imagined Justina in front of me and I danced my heart out. I was aggressive, sexual and caught up in the nature of my desire'
- **b07** @9571 sc=100
  - items: Emotion | Positive emotion
  - excerpt: 'I did pick my book back up, but with a smile on my face'
- **b08** @9952 sc=100
  - items: Amnesia
  - excerpt: "I don't remember much of the next song. I'm not sure if this is possible with psylocibin but I felt like I was so high that I was blacking out of consciousness every few minutes."
- **b09** @10265 sc=100
  - items: Sensory delight | Visual | Nature
  - excerpt: 'The images of the spiders transfixed me to my spot and I felt a strange sort of vibration rumbling all throughout my body to culminate at my hands'
- **b10** @12177 sc=100
  - items: Emotion | Negative emotion
  - excerpt: 'So I headed to warmth and felt a twinging regret in the back of my mind that I was giving up on facing pain'
- **b11** @12286 sc=100
  - items: Emotion | Negative emotion
  - excerpt: "I was seeking warmth. That thought nearly brought me to tears. Because I honestly desire warmth, both physically and emotionally from those close to me. But I don't receive any, emotionally at least."
- **b12** @12684 sc=100
  - items: Insight | Existential
  - excerpt: "I'm living my life seeking warmth and pretending I enjoy the cold."
- **b13** @13922 sc=100
  - items: Amnesia
  - excerpt: "After I got out of the park, my memory left me until the middle of Black or White. That's means there are at least 11 minutes that I just don't remember"
- **b14** @14964 sc=100
  - items: Emotion | Negative emotion
  - excerpt: "I almost stopped the song because I was frustrated that it wasn't addressing my scenario specifically"
- **b15** @17138 sc=100
  - items: Emotion | Negative emotion
  - excerpt: "I wasn't feeling anything strong enough to bring even a single tear. I started crying shortly after though."
- **b16** @18015 sc=100
  - items: Insight | Existential
  - excerpt: "I still didn't have the words to tell her how I felt, or know how to make things physical between us but I tried as hard as I could with my actions to show her that I was head over heels for her. And it plain didn't work. That's what happened."
- **b17** @18374 sc=100
  - items: Amnesia
  - excerpt: "I don't remember what else I thought about, but eventually at some point I moved from besides that van and kept walking towards home."
- **b18** @18806 sc=100
  - items: Emotion | Negative emotion
  - excerpt: "I felt ashamed and belittled that I didn't even have a place I could call my own"
- **b19** @19162 sc=100
  - items: Sense of reality | Lucid
  - excerpt: "I briefly considered driving the truck to a secluded spot, but abandoned that idea. I was in no condition to drive. As soon as that thought hit my mind, I chafed at it and said to myself, 'What, I'm not responsible enough to drive on shrooms?"
- **b20** @19822 sc=100
  - items: Amnesia
  - excerpt: "I don't remember much except saying at the end, 'How could you say that to me?'"
- **b21** @20012 sc=100
  - items: Insight | Existential
  - excerpt: "Justina had given me a pocketwatch with those words engraved on it. I didn't realize why I took objection to that at the time, but I do now. No one is allowed to put a claim on me like that unless they are my spouse."
- **b22** @21294 sc=100
  - items: Emotion | Negative emotion
  - excerpt: 'My foot knocked against a basket of clean laundry that she must have placed in my room that day and I immediately felt ashamed.'
- **b23** @21867 sc=100
  - items: Emotion | Negative emotion
  - excerpt: 'Now I was disgusted by myself and wondered how other people could stand to be around me without recoiling.'
- **b24** @22425 sc=100
  - items: Insight | Existential
  - excerpt: "The main idea that I'm going to take from this trip is that I need to leave my parents. They're an obstacle in the path of my self-growth and if I want to blossom I need to be on my own away from their judgmental, manipulative actions."
- **b25** @23416 sc=100
  - items: Insight | Existential
  - excerpt: 'Rather than focusing on my appearance, what I have to do is accept myself as a whole. I am so much more than my body. There are ideas, actions, and ways of being that all belong to me and combine to create Zubair.'
- **b26** @23980 sc=100
  - items: Insight | Existential
  - excerpt: "I am a different person to different people. I have almost no preferences and yet I don't like to be associated with the passivity that that implies. So I arbitrarily pick quirks and interests whenever I meet a new group of people."
- **b27** @25330 sc=100
  - items: Arousal | Abnormally low
  - excerpt: 'I began telling myself vehemently to stay awake.'
- **b28** @25464 sc=100
  - items: Sense of reality | Lucid
  - excerpt: 'I was not going to waste this trip - which I expected so much from - by pissing it away on a dream.'
- **b29** @26184 sc=100
  - items: Insight | Existential
  - excerpt: "So I asked myself if I've ever let myself just be. Now I know that sounds like New-Age nonsense, but what followed was a very relaxing and rewarding experience. I pushed every thought out of my head and listened to what my body was telling me. Then I danced."
- **b30** @26285 sc=100
  - items: Emotion | Positive emotion
  - excerpt: 'what followed was a very relaxing and rewarding experience.'
- **b31** @26770 sc=100
  - items: Emotion | Positive emotion
  - excerpt: 'I saw the green light of the smoke detector making a peace sign. It brought a smile to my face.'
- **b32** @29127 sc=100
  - items: Insight | Existential
  - excerpt: "I remember saying that I don't care what the world is like. I'm going to change it all to suit my liking for the brief time I spend here."
